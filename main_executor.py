...
if __name__ == '__main__':
    ...
    parser.add_argument("-mip_loss_coeff",
                        type=float,
                        default=0.3,
                        help="coefficient for mip loss in total loss computation")
    parser.add_argument("-floss_coeff",
                        type=float,
                        default=0.7,
                        help="coefficient for floss in total loss computation")
    ...
    pipeline = Pipeline(cmd_args=args, model=model, logger=logger,
                        ...
                        writer_training=writer_training, writer_validating=writer_validating, wandb=None)
